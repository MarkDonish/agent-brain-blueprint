...
- Anything that belongs in `80_sensitive_isolation/` or outside the vault entirely.

## Directory map

- `10_projects/` project state, handoffs, validation, decisions, summaries
- `40_handoffs/session_claims/` narrow multi-session claims
- `70_inbox/` unprocessed source pointers
- `80_sensitive_isolation/` hard boundary; keep out of Git and public derivatives
